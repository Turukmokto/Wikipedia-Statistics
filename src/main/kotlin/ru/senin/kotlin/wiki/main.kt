...
fun main(args: Array<String>) {
    try {
        ...
        val lasting = measureTime {
            solution(parameters.inputs, parameters.output, parameters.threads)
        }
        println("Threads: ${parameters.threads}")
        println("Time: ${lasting.inWholeMilliseconds} ms")
    } catch (e: Exception) {
